...
const gitUrl = 'https://github.com/gitockham/ock-core'
...
class GenerateManager {
  ...
  createFiles() {
    ...
    this.nodes.forEach( (node, index) => {
      ...
      const distCryptoNetworkPath = path.join(distNodePath, 'packages/crypto/lib/networks/ock')
      ...
      fs.mkdir(distCoreNetworkPath, (err) => {
        ...
        const ockScript = index > 0 ? 'ock.sh' : 'ock-network-start.sh'
